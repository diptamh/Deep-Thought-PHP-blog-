	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="<?php echo base_url(); ?>">Deep Thought</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse" id="navbarColor02">
          ...
          <?php if(!$this->session->userdata('logged_in')) : ?>
            <li class="nav-item "><a href="<?php echo base_url(); ?>users/login">Login</a></li>
          ...
          <?php if($this->session->userdata('logged_in')) : ?>
            ...
            <li class="nav-item "><a href="<?php echo base_url(); ?>categories/create">Create Category</a></li>
